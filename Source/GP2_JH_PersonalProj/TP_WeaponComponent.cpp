...
void UTP_WeaponComponent::AttachWeapon(AGP2_JH_PersonalProjCharacter* TargetCharacter)
{
	...
	AttachToComponent(Character->GetMesh1P(), AttachmentRules, FName(TEXT("customgun1")));   //maybe switch or create derived class, i don't know. create another attachweapon function.
